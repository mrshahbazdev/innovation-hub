                    ...
                    <div class="border-t pt-4 mt-4 grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2 p-2 bg-yellow-50 rounded-md">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="schmerz" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm" @disabled(!auth()->user()->is_admin && !$idea->team?->hasUserWithPermission(auth()->user(), 'update-yellow'))>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700">Umsetzung</label>
                                <input type="number" wire:model="umsetzung" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm" @disabled(!auth()->user()->is_admin && !$idea->team?->hasUserWithPermission(auth()->user(), 'update-yellow'))>
                            </div>
                        </div>
                        <div class="space-y-2 p-2 bg-red-50 rounded-md">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="kosten" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm" @disabled(!auth()->user()->is_admin && !$idea->team?->hasUserWithPermission(auth()->user(), 'update-red'))>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700">Dauer</label>
                                <input type="number" wire:model="dauer" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm" @disabled(!auth()->user()->is_admin && !$idea->team?->hasUserWithPermission(auth()->user(), 'update-red'))>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <label class="block text-xs font-medium text-gray-700">Lösung</label>
                            <textarea wire:model="loesung" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm" @disabled(!auth()->user()->is_admin && !$idea->team?->hasUserWithPermission(auth()->user(), 'update-red'))></textarea>
                        </div>
                    </div>
                @else
